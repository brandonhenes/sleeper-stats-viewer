...
5. Data is cached in SQLite and displayed as league groups
...
### Caching Strategy
- **SQLite Cache**: Local `sleeper.db` file stores all data
- **Tables**: 
  - users, leagues, rosters, roster_players, user_leagues
...
- **SQLite** (better-sqlite3): Local caching layer for Sleeper API responses with WAL mode enabled
